...
class ProvidersViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        cell.providerImage.image = provider.profilePicture
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let selectedProvider: Provider = surveyProviders![indexPath.row]
//        
//        self.view.addSubview(blurEffectView!)
//        let vc = self.storyboard?.instantiateViewController(withIdentifier: "ProviderSelectedPresentationViewController") as! ProviderSelectedPresentationViewController
//        vc.modalPresentationStyle = .popover
//        vc.preferredContentSize = CGSize(width: 500, height: 320)
//        vc.selectedProviderPassedImage = providerProfileImages[(indexPath as NSIndexPath).row]
//        vc.JMSdelegate = self
